...
#ifndef lint
static char rcsid[] = "$Id: chat.c,v 1.2 2001/06/26 19:07:30 evan Exp $";
#endif
...
size_t strftime(char *__s, size_t __smax, const char *__fmt, const struct tm *__tp) { __s[0]=0; return(0); }
#endif
